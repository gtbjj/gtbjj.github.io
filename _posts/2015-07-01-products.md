...
<div class="expando" id="supplements">
    ...
    <ul style="list-style-type: none">
        ...
        <li>
            ...
            <br>
            Native offers natural personal care products (toothpaste, deodorant, body wash) that are free from harmful chemicals, smell great, and actually work.  We all know some "natural" products deliver less than admirable results.  Not so with Native!  Get a <code>free mini-deodorant</code> with your order by using the link below.
            <br>
            <br>
